...
# EXTTOOL is a command that is run before the rest of building
#
...
INCLUDES		:=	include entt $(TEMPINCLUDE) include/components include/audio include/scenes include/util include/shaders include/physics
GRAPHICS		:=	gfx
ROMFS		    :=	romfs
APP_TITLE       := 	quicklime
