...
class material {
     ...
     * @return A shared pointer to the texture. If the name is blank, will load a blank white texture. If the specified name cannot be found, the return value will be empty.
     */
