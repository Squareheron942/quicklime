...
class Camera {
	// void transformobjs_r(GameObject* obj, C3D_Mtx& parentmodelmtx, C3D_FVec
	// pos, C3D_FVec topN, C3D_FVec botN, C3D_FVec leftN, C3D_FVec rightN,
	// C3D_FVec nearN, C3D_FVec farN);
	LightLock lock;
  ...
  public:
	...
	/**
	 * @brief Dictates how to map the iod input from the slider to the rendering
	 * iod
