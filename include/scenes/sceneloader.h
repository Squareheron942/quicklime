...
class SceneLoader {
    ...
    static void parseChildren(std::unique_ptr<Scene>& s, GameObject& object, std::string_view& input);
    static void parseChildrenAsync(std::unique_ptr<Scene>& s, GameObject& object, std::string_view& input, unsigned int size, float& progress);
    static void parseComponent(std::unique_ptr<Scene>& s, GameObject& object, std::string_view input);
    static void parseComponents(std::unique_ptr<Scene>& s, GameObject& object, std::string_view& input);
    static void parseScripts(std::unique_ptr<Scene>& s, GameObject& object, std::string_view& input);
    static void parseObject(std::unique_ptr<Scene>& s, std::string_view& input);
    static void parseObjectAsync(std::unique_ptr<Scene>& s, std::string_view& input, unsigned int size, float& progress);
