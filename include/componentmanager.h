...
class ComponentManager {
    ...
    template<typename T> static void createComponentInstance(GameObject& obj, void* data) { obj.reg.emplace_or_replace<T>(obj.id, obj, data); }
    ...
    private:
        ...
        static std::unordered_map<const char*, Script*(*)(GameObject&)>& getScriptMap() { static std::unordered_map<const char*, Script*(*)(GameObject&)> map; return map; }
        static std::unordered_map<const char*, void(*)(GameObject&, void*)>& getComponentMap() { static std::unordered_map<const char*, void(*)(GameObject&, void*)> map; return map; }
};
